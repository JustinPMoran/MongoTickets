...
public class onetomany {
    ...
    CommandLineRunner initUser(UserRepository userRepository, TicketRepository ticketRepository) {
        return args -> {
            ...
            Ticket ticket4 = new Ticket("Soccer", "May 3", "A8", 1);
            Ticket ticket5 = new Ticket("Football", "Sep 23", "G8", 8);
            Ticket ticket6 = new Ticket("Baseball", "Sep 22", "A1", 4);

            user1.setTicket(ticket1);
            user1.setTicket(ticket2);
            user1.setTicket(ticket5);
            user2.setTicket(ticket6);
            user2.setTicket(ticket4);
