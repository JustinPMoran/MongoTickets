...
public class PeopleController {
    ...
    // New Feature: Search by rank
    @GetMapping("/people/rank/{rank}")
    public List<Person> getPersonsByRank(@PathVariable String rank) {
        return peopleList.values().stream()
                .filter(person -> person.getRank().equalsIgnoreCase(rank))
                .collect(Collectors.toList());
    }
